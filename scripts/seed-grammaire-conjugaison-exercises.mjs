/**
 * Priorité 5 du plan de migration CEPE (uniformisation Exercices) — lot 1 :
 * ajoute 2 exercices guidés par chapitre pour Grammaire (14 chapitres) et
 * Conjugaison (9 chapitres), qui n'en avaient aucun jusqu'ici.
 *
 * Usage : node scripts/seed-grammaire-conjugaison-exercises.mjs [--dry-run]
 */
...
const { exercisesByChapter } = await import(`file:///${SCRATCHPAD}/grammaire-conjugaison-exercises.mjs`)
