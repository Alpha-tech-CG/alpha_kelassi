/**
 * Priorité 5 du plan de migration CEPE (uniformisation Exercices) — lot 3 :
 * ajoute 2 exercices guidés par chapitre pour Numération (6) et SVT (16).
 *
 * Usage : node scripts/seed-numeration-svt-exercises.mjs [--dry-run]
 */
...
const { exercisesByChapter } = await import(`file:///${SCRATCHPAD}/numeration-svt-exercises.mjs`)
