/**
 * Priorité 5 du plan de migration CEPE (uniformisation Exercices) — lot 2 :
 * ajoute 2 exercices guidés par chapitre pour Orthographe grammaticale (8),
 * Orthographe d'usage (2) et Vocabulaire (7).
 *
 * Usage : node scripts/seed-ortho-vocab-exercises.mjs [--dry-run]
 */
...
const { exercisesByChapter } = await import(`file:///${SCRATCHPAD}/ortho-vocab-exercises.mjs`)
