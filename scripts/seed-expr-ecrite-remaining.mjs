/**
 * Complète les 3 derniers chapitres CEPE sans exercices : "La structure d'un devoir
 * de rédaction", "La lettre — Structure et modèle", "Poème : Le Corbeau et le Renard"
 * (domaine Expression écrite). Clôture la priorité 5 du plan de migration CEPE.
 *
 * Usage : node scripts/seed-expr-ecrite-remaining.mjs [--dry-run]
 */
...
const { exercisesByChapter } = await import(`file:///${SCRATCHPAD}/expr-ecrite-remaining-exercises.mjs`)
