...
export default function VideosScreen() {
  ...
  if (loading) return <ActivityIndicator style={{ flex: 1 }} color="#dc2626" />
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden', marginBottom: 14, borderWidth: 1, borderColor: '#f3f4f6' },
  thumbWrap: { position: 'relative', width: '100%', aspectRatio: 16 / 9, backgroundColor: '#e5e7eb' },
  thumb: { width: '100%', height: '100%' },
  thumbEmpty: { alignItems: 'center', justifyContent: 'center' },
  playIcon: { fontSize: 32, color: '#9ca3af' },
  ...
  meta: { padding: 12 },
  videoTitle: { fontSize: 14, fontWeight: '600', color: '#111827' },
  videoSub: { fontSize: 12, color: '#9ca3af', marginTop: 3 },
})
