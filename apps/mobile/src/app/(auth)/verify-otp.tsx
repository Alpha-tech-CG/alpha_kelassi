...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#F4F8FE', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 24 },
  ...
  button: { backgroundColor: '#1E74E8', borderRadius: 10, paddingVertical: 15, alignItems: 'center', width: '100%' },
