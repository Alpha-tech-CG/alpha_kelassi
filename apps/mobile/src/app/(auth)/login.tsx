...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 36, fontWeight: '800', textAlign: 'center', color: '#0B6B3A', marginBottom: 4 },
  subtitle: { fontSize: 14, color: '#6D7A72', textAlign: 'center', marginBottom: 32 },
  tabs: { flexDirection: 'row', backgroundColor: '#DDE8E1', borderRadius: 10, padding: 4, marginBottom: 20 },
  tab: { flex: 1, paddingVertical: 8, borderRadius: 8, alignItems: 'center' },
  tabActive: { backgroundColor: '#fff', shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 4, elevation: 2 },
  tabText: { fontSize: 14, color: '#6D7A72' },
  tabTextActive: { color: '#1F2A24', fontWeight: '600' },
  input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#DDE8E1', borderRadius: 10, paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, marginBottom: 12 },
  phoneRow: { flexDirection: 'row', marginBottom: 12 },
  prefix: { backgroundColor: '#EEF8F4', borderWidth: 1, borderColor: '#DDE8E1', borderRightWidth: 0, borderTopLeftRadius: 10, borderBottomLeftRadius: 10, paddingHorizontal: 14, justifyContent: 'center' },
  prefixText: { fontSize: 15, color: '#1F2A24' },
