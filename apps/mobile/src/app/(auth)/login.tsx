...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 36, fontWeight: '800', textAlign: 'center', color: '#1d4ed8', marginBottom: 4 },
  ...
  input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#d1d5db', borderRadius: 10, paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, marginBottom: 12 },
  phoneRow: { flexDirection: 'row', marginBottom: 12 },
  prefix: { backgroundColor: '#f3f4f6', borderWidth: 1, borderColor: '#d1d5db', borderRightWidth: 0, borderTopLeftRadius: 10, borderBottomLeftRadius: 10, paddingHorizontal: 14, justifyContent: 'center' },
  prefixText: { fontSize: 15, color: '#374151' },
  phoneInput: { flex: 1, borderTopLeftRadius: 0, borderBottomLeftRadius: 0, marginBottom: 0 },
  button: { backgroundColor: '#2563eb', borderRadius: 10, paddingVertical: 15, alignItems: 'center', marginBottom: 16 },
