...
const styles = StyleSheet.create({
  ...
  counter: { fontSize: 13, color: '#6D7A72' },
  timer: { fontSize: 15, fontWeight: '700', color: '#1F2A24' },
  timerLow: { color: '#E53935' },
  progressBar: { height: 4, backgroundColor: '#DDE8E1', marginHorizontal: 20, borderRadius: 2, overflow: 'hidden', marginBottom: 16 },
  progressFill: { height: '100%', backgroundColor: '#0F8F4F' },
  qContent: { padding: 20 },
  prompt: { fontSize: 18, fontWeight: '700', color: '#1F2A24', marginBottom: 20, lineHeight: 26 },
  option: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderWidth: 1, borderColor: '#DDE8E1', borderRadius: 14, padding: 14, marginBottom: 10 },
  optionSelected: { borderColor: '#0F8F4F', backgroundColor: '#EAF5EC' },
  optionLetter: { width: 26, height: 26, borderRadius: 13, borderWidth: 1, borderColor: '#DDE8E1', textAlign: 'center', lineHeight: 26, fontWeight: '700', fontSize: 12, color: '#6D7A72', marginRight: 12 },
  optionLetterSelected: { borderColor: '#0F8F4F', color: '#0F8F4F' },
  optionText: { flex: 1, fontSize: 15, color: '#1F2A24' },
  optionTextSelected: { color: '#1e3a8a', fontWeight: '500' },
  navBar: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 20, borderTopWidth: 1, borderTopColor: '#EEF8F4' },
  navPrev: { paddingVertical: 10 },
  navPrevText: { color: '#6D7A72', fontSize: 14 },
  navNext: { backgroundColor: '#1F2A24', borderRadius: 12, paddingVertical: 12, paddingHorizontal: 24 },
  navNextText: { color: '#fff', fontWeight: '700', fontSize: 14 },
  finishBtn: { backgroundColor: '#0F8F4F', borderRadius: 12, paddingVertical: 12, paddingHorizontal: 28 },
  finishText: { color: '#fff', fontWeight: '700', fontSize: 14 },
  resultCard: { backgroundColor: '#fff', borderRadius: 20, padding: 28, alignItems: 'center', marginBottom: 20, borderWidth: 1, borderColor: '#EEF8F4' },
  resultEmoji: { fontSize: 48, marginBottom: 8 },
  resultScore: { fontSize: 34, fontWeight: '800', color: '#1F2A24' },
  resultPct: { fontSize: 14, color: '#6D7A72', marginTop: 4 },
  xp: { fontSize: 14, fontWeight: '700', color: '#0F8F4F', marginTop: 8 },
  reviewCard: { backgroundColor: '#fff', borderRadius: 14, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: '#EEF8F4' },
  reviewPrompt: { fontSize: 14, fontWeight: '600', color: '#1F2A24', marginBottom: 10 },
  reviewOpt: { fontSize: 13, color: '#6D7A72', paddingVertical: 6, paddingHorizontal: 10, borderRadius: 8, marginBottom: 4 },
  reviewRight: { backgroundColor: '#EAF5EC', color: '#0B6B3A', fontWeight: '600' },
  reviewWrong: { backgroundColor: '#FCE9E8', color: '#E53935' },
  explanation: { fontSize: 13, color: '#6D7A72', fontStyle: 'italic', marginTop: 6 },
  primaryBtn: { backgroundColor: '#0F8F4F', borderRadius: 14, paddingVertical: 16, alignItems: 'center', marginTop: 8 },
